...
select survived,avg(age) as not_survived from titanic group by survived;

#29. List the names of passengers who were in 1st class and had an age greater than 50. 
select name,pclass,survived from titanic group by survived,pclass,age,name having pclass=1 and survived = 'survived' and age >50;
